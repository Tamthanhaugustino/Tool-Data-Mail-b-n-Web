...
export default function SettingsPage() {
  return (
    <AppShell title="Settings" breadcrumb={{ parent: "Account", current: "Settings" }}>
      <SettingsContent />
    </AppShell>
  );
}
        ...
        <TabsContent value="account">
          <Card className="shadow-sm">
            ...
            <CardContent className="grid max-w-md gap-4">
              <div className="space-y-2">
                <Label>Họ tên</Label>
                <Input defaultValue="Nguyễn Thị Trang" />
              </div>
              <div className="space-y-2">
                <Label>Email</Label>
                <Input defaultValue="trang.nguyen@vietsoftware.com.vn" readOnly />
              </div>
